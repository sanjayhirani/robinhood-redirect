# robinhood_sell_puts_main_updated_skip2.py
...
for TICKER in safe_tickers:
    try:
        ...
        for exp_date in exp_dates:
            ...
            # Skip first 2 strikes, take next 3
        ...
        # send alert
        if candidate_puts:
            selected_strikes = [p['Strike Price'] for p in candidate_puts]
            msg_lines = [
